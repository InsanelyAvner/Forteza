...
(function ($) {
	...
	////////////////////////////////////////////////////
	// 03. Sidebar Js
	$(".fz-menu-toggle").on("click", function () {
		$(".fz-sidebar-menu").addClass("sidebar-opened");
		$(".body-overlay").addClass("opened");
	});
	$(".sidebar-close").on("click", function () {
		$(".fz-sidebar-menu").removeClass("sidebar-opened");
